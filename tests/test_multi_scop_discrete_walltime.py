...
import numpy as np
import pandas as pd
from benchmarks.benchmark_multi_scop_discrete_convergence import SummaryRow, _prediction_metrics
...
def test_summary_csv_columns_include_gate_and_order_fields():
    row = SummaryRow(
        ...
        n_rows=10,
        repeats=3,
        execution_order="baseline->optimized|optimized->baseline|baseline->optimized",
