...
- the reference implementation parallels: discretized marginal storage + XWXd-style packed cross products explicitly cited (algebra.py:487–491, dm_builder.py:1305–1309).
